...
from the requirements.txt:
    ...
    4. You need to make changes to the files "client_secrets.json" and "fb_client_secrets.json", "login.html" 
    specifying the YOUR_CLIENT_SECRET, YOUR_CLIENT_ID, app_secret, app_id, data-clientid, appId
